  ...
  return (
    <>
      <Container className="mt-9 xl:mt-28">
        <div className="mx-auto flex gap-12 max-xl:max-w-3xl max-xl:flex-col xl:items-center xl:gap-19.75">
          <Button href="/projects" plain className="w-fit -translate-x-2.5 py-0.5! pr-2.5! pl-1.5! font-medium!">
      ...
      <div className="w-full px-6">
        <div className="mx-auto mt-5 flex w-full max-w-3xl flex-col">
          ...
          {post.meta.lead ? (
            <p className="mt-6 text-base/8 text-zinc-700 dark:text-zinc-300">{post.meta.lead}</p>
          ) : null}
