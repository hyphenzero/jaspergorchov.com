...
export const meta = {
  ...
  lead: `This summer I completely redesigned my personal website, making it the perfect place to showcase my work and share my thoughts. It’s built with Next.js 16 and Tailwind CSS v4.0, and it uses MDX for the projects and blog posts.`,
  date: '2026-06-16',
  image: card,
  tags: ['Releases'],
}
