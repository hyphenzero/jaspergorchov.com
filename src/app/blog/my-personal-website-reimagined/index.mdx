...
export const meta = {
  ...
  lead: `This summer I completely redesigned my personal website, making it the perfect place to showcase my work and share my thoughts. The site is built with Next.js 16 and Tailwind CSS v4.0 and uses MDX for the projects and blog posts.`,
  date: '2026-06-16',
  image: card,
  tags: ['Releases'],
}
...
export const Link = forwardRef(function Link(
  props: { href: string } & React.ComponentPropsWithoutRef<'a'>, // [!code --]
  props: LinkProps & React.ComponentPropsWithoutRef<'a'>, // [!code ++]
  ref: React.ForwardedRef<HTMLAnchorElement>
) {
  return (
    <Headless.DataInteractive>
      <a {...props} ref={ref} /> // [!code --]
      <NextLink {...props} ref={ref} /> // [!code ++]
    </Headless.DataInteractive>
  )
})
```
...
<Example resizable>
  {
    <div className="grid perspective-distant">
      <article className="relative isolate z-10 flex w-full max-w-80 rotate-x-51 rotate-z-43 flex-col justify-end justify-self-center overflow-hidden rounded-2xl bg-zinc-900 px-8 pt-80 pb-8 shadow-xl transition-all duration-500 transform-3d">
        <img
          src="https://images.unsplash.com/photo-1496128858413-b36217c2ce36?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=3603&q=80"
          alt=""
          className="absolute inset-0 -z-10 size-full object-cover"
        />
        <div className="absolute inset-0 -z-10 bg-linear-to-t from-zinc-900 via-zinc-900/40"></div>
        <div className="absolute inset-0 -z-10 rounded-2xl ring-1 ring-zinc-900/10 ring-inset"></div>
        <div className="flex flex-wrap items-center gap-y-1 overflow-hidden text-sm/6 text-zinc-300">
    ...
    <Iframe className="h-85 w-full">
      <div className="grid h-full items-center justify-center">
        ...
        <div
          popover="auto"
          id="my-popover"
          className="relative inset-y-0 mx-auto my-auto transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left opacity-0 shadow-xl ring ring-black/5 transition-all transition-discrete duration-500 sm:w-full sm:max-w-96 sm:p-6 dark:bg-zinc-800 dark:inset-ring dark:inset-ring-white/5 [[open],:popover-open]:opacity-100 starting:[[open],:popover-open]:opacity-0"
        >
          <div>
            ...
            <div className="mt-3 text-center sm:mt-5">
              <div className="text-base font-semibold text-zinc-900 dark:text-white" id="modal-title">
                Update available
              </div>
              <div className="mt-2">
