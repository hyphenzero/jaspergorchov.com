  ...
  return (
    <>
      <PageIntro eyebrow="About" title="Hi, I’m Jasper">
        <p>
          I’m Jasper Gorchov, a 13-year-old developer creating immersive
          web-based apps and vibrant 3D illustrations.
        </p>
        <div className="mt-10 max-w-2xl space-y-6 text-base">
          <p>
            ...
            age 10. When I first downloaded VScode on my Mac, I was introduced
            to a world of creative computing as I began to learn about tools
            like{' '}
