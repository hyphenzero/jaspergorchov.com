...
export function Banner({ latestTitle, latestUrl }: BannerProps) {
  return (
    <div className="@container flex w-full justify-start pl-2 sm:pl-8">
      <a
        href={latestUrl}
        className="flex flex-nowrap items-center gap-2 rounded-full px-3 py-2 text-xs/4 whitespace-nowrap ring ring-zinc-950/8 transition hover:bg-zinc-950/2 hover:ring-zinc-950/10 @max-[22rem]:hidden dark:ring-white/8 dark:hover:bg-white/2 dark:hover:ring-white/10"
      >
