  ...
  return (
    <LayoutGroup id={id}>
      <div
        ...
        className={clsx(
          className,
          'flex items-center gap-10 has-[[data-nav-item]:hover]:[&>[data-nav-item]:not(:hover)]:opacity-50'
        )}
      />
    </LayoutGroup>
  )
...
export const NavbarItem = forwardRef(function NavbarItem(
  ...
  return (
    <span data-nav-item className={clsx(className, 'relative transition-opacity duration-200')}>
        ...
        {current && (
          <motion.span
            ...
            className={clsx(
              ...
              'bottom-[-1.34375rem]' // -21.5px, in the middle of the header’s bottom border
            )}
          />
        )}
      </AnimatePresence>
