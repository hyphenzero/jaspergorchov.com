...
const styles = {
  base: [
    ...
    // Sizing
    'px-[calc(calc(var(--spacing)*4.5)-1px)] py-[calc(calc(var(--spacing)*2.5)-1px)] sm:px-[calc(calc(var(--spacing)*3.5)-1px)] sm:py-[calc(calc(var(--spacing)*1.5)-1px)] sm:text-sm/6',
    // Focus
