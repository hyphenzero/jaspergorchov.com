...
export function Card<T extends React.ElementType = 'div'>({
  ...
  return (
    <Component
      {...props}
      className={clsx(
        'relative rounded-xl dark:bg-zinc-900 bg-zinc-50 forced-colors:outline',
        !flat&& 'shadow-[0px_0px_0px_1px_rgba(9,9,11,0.07),0px_2px_2px_0px_rgba(9,9,11,0.05)] dark:shadow-[0px_0px_0px_1px_rgba(255,255,255,0.1)] dark:before:pointer-events-none dark:before:absolute dark:before:-inset-px dark:before:rounded-[calc(theme(borderRadius.xl)+1px)] dark:before:shadow-[0px_2px_8px_0px_rgba(0,_0,_0,_0.20),_0px_1px_0px_0px_rgba(255,_255,_255,_0.06)_inset]',
        className
      )}
    >
      {children}
