...
export function HeroSection({ projects }: Props) {
  ...
  return (
    <>
      ...
      <div
        ref={contentRef}
        className="relative mx-auto mt-[100dvh] flex translate-y-[calc(-100%-70px)] sm:translate-y-[calc(-100%-62px)] lg:translate-y-[calc(-100%-60px)] flex-col gap-10 px-6 pb-8 md:pb-12 md:flex-row md:items-end md:justify-between md:gap-8 md:px-10 lg:px-14"
      >
        ...
        <div className="flex flex-col items-center justify-between max-sm:*:w-full sm:max-md:flex-row sm:max-md:items-center md:self-stretch">
          ...
          <div className="flex w-full max-sm:mt-6 items-center justify-between px-6 sm:max-md:ml-12 sm:max-md:px-0">
