...
function StatCard({ label, value }: { label: string; value: number }) {
  return (
    <div className="flex flex-col border-l border-zinc-950/10 px-4 py-3 dark:border-white/10">
      <p className="font-mono text-xs font-semibold tracking-widest text-zinc-600 uppercase dark:text-zinc-400">
        {label}
      </p>
      <p className="mt-4 text-5xl tracking-tight text-zinc-950 tabular-nums dark:text-white">{value}</p>
    </div>
  )
}
    ...
    <div className="space-y-24">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="relative rounded-xl bg-white p-5 shadow-[0px_0px_0px_1px_rgba(9,9,11,0.07),0px_2px_2px_0px_rgba(9,9,11,0.05)] dark:bg-zinc-900 dark:shadow-[0px_0px_0px_1px_rgba(255,255,255,0.1)] dark:before:pointer-events-none dark:before:absolute dark:before:-inset-px dark:before:rounded-xl dark:before:shadow-[0px_2px_8px_0px_rgba(0,0,0,0.20),0px_1px_0px_0px_rgba(255,255,255,0.06)_inset] forced-colors:outline">
          <h3 className="text-sm font-semibold text-zinc-950 dark:text-white">Button clicks</h3>
          {buttonClicks.length === 0 ? (
            ...
            <div className="mt-4">
              <div className="flex items-center justify-between border-b border-zinc-100 px-1 py-2 dark:border-zinc-800">
                <span className="font-mono text-xs font-medium tracking-widest text-zinc-500 uppercase">Button</span>
              ...
              {buttonClicks.map((row) => {
                ...
                return (
                  <div
                    key={row.name}
                    className="relative flex items-center gap-3 border-b border-zinc-100 px-1 py-2.5 dark:border-zinc-800/50"
                  >
                    <div
                      className="absolute inset-y-0 left-0 rounded bg-sky-400/8 dark:bg-sky-400/5"
                      style={{ width: `${pct}%` }}
                    />
                    <span className="relative min-w-0 flex-1 truncate text-sm font-medium text-zinc-700 dark:text-zinc-300">
      ...
      <div className="relative rounded-xl bg-white p-5 shadow-[0px_0px_0px_1px_rgba(9,9,11,0.07),0px_2px_2px_0px_rgba(9,9,11,0.05)] dark:bg-zinc-900 dark:shadow-[0px_0px_0px_1px_rgba(255,255,255,0.1)] dark:before:pointer-events-none dark:before:absolute dark:before:-inset-px dark:before:rounded-xl dark:before:shadow-[0px_2px_8px_0px_rgba(0,0,0,0.20),0px_1px_0px_0px_rgba(255,255,255,0.06)_inset] forced-colors:outline">
        <h3 className="text-sm font-semibold text-zinc-950 dark:text-white">Site preview opens</h3>
        {previewClicks.length === 0 ? (
          ...
          <div className="mt-4">
            <div className="flex items-center justify-between border-b border-zinc-100 px-1 py-2 dark:border-zinc-800">
              <span className="font-mono text-xs font-medium tracking-widest text-zinc-500 uppercase">Page</span>
